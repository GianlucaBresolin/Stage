...
\begin{center}
    ...
    \begin{longtable}{|p{2.5cm}|p{10cm}|}
        ...
        di Datasoil S.r.l.                                                                                                               \\
        \hline
        R.V.O.8            & La libreria deve mantenere la compatibilità con i dati in formato \textit{JSON} forniti dal backend,
        precedentemente utilizzati nel preesistente SDK \textit{dsdashboard}.                                                            \\
        \hline
        R.V.O.9            & La libreria deve mantenere la compatibilità con le API REST del backend esistenti, garantendo che tutte le
        richieste e le risposte continuino a funzionare correttamente.                                                                   \\
        \hline
        R.V.O.10           & Le modifiche effettuate ai tipi di dato all'interno della nuova libreria devono essere retrocompatibili con
