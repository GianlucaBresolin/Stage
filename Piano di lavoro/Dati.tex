...
% Dati dello Studente
\newcommand{\nomeStudente}{Gianluca}
\newcommand{\cognomeStudente}{Bresolin}
\newcommand{\matricolaStudente}{2034316}
\newcommand{\emailStudente}{gianluca.bresolin@studenti.unipd.it}
\newcommand{\telStudente}{+ 39 391 30 47 314}
...
% Dati dell'Azienda
\newcommand{\ragioneSocAzienda}{Datasoil s.r.l.}
\newcommand{\indirizzoAzienda}{Viale Codalunga, Padova (PD)}
\newcommand{\sitoAzienda}{https://datasoil.it/}
\newcommand{\emailAzienda}{info@datasoil.it}
\newcommand{\partitaIVAAzienda}{P.I./C.F.: 05013950281}
